...
type ScreenContentItemContentEditorView =
  ScreenContentItemContentEditorViewMethods;

const ScreenContentItemContentEditorView = React.forwardRef<
  ScreenContentItemContentEditorView,
  ScreenContentItemContentEditorViewProps
>((props, ref) => {
  const { containerStyle, screenContentItem, onChange } = props;
...
export default ScreenContentItemContentEditorView;
