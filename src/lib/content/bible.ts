export const bible = [
  ...
  },
  {
    name: 'Numbers',
    chapters: [
      36, 54, 34, 51, 49, 31, 27, 89, 26, 23, 36, 35, 16, 33, 45, 41, 50, 13,
      32, 22, 29, 35, 41, 30, 25, 18, 65, 23, 31, 40, 16, 54, 42, 56, 29, 34,
      13,
    ],
  },
  {
    name: 'Deuteronomy',
    chapters: [
      34, 46, 37, 29, 49, 33, 25, 26, 20, 29, 22, 32, 32, 18, 29, 23, 22, 20,
  ...
  {
    name: 'Roman',
    chapters: [32, 29, 31, 25, 21, 23, 25, 39, 33, 21, 36, 21, 14, 26, 33, 25],
  },
  {
    name: '1 Corinthians',
